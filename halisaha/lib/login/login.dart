...
import 'package:halisaha/Screens/homeScreen.dart';
import 'package:halisaha/login/forgotpassword.dart';
import 'package:halisaha/login/signup.dart';
...
class _LOGINState extends State<LOGIN> {
      ...
      if (user != null) {
        setState(() {
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    HomePageWidget()), //login sonrası gidilecek sayfa
          );
        });
      }
    } catch (e) {
  ...
  void createData() {
    databaseReference
        .child("asadsadsas")
        .set({'email': "girilen", 'sifre': "girilenpassword"});
  }
}
